...
class DatasetEvaluator:
    ...
    def evaluate(self):
        """
        Evaluate/summarize the performance, after processing all input/caption pairs.
        Returns:
            dict:
...
#             evaluator.reset()
#
#     def process(self, input, caption):
#         for evaluator in self._evaluators:
#             evaluator.process(input, caption)
#
#     def evaluate(self):
#         results = OrderedDict()
#         for evaluator in self._evaluators:
