...
# Resume training from the latest checkpoint in the caption directory
...
def dump_cfg():
    """Dumps the config to the caption directory."""
...
def load_cfg(out_dir, cfg_dest="config.yaml"):
    """Loads config from specified caption directory."""
