...
model_name = {
    '18x': 'resnet18-5c106cde.pth',
    '34x': 'resnet34-333f7ec4.pth',
    '50x': 'resnet50-19c8e357.pth',
    '101x': 'resnet101-5d3b4d8f.pth',
    'ibn_18x': 'resnet18_ibn_a-2f571257.pth',
    'ibn_34x': 'resnet34_ibn_a-94bc1577.pth',
    'ibn_50x': 'resnet50_ibn_a-d9d0bb7b.pth',
    'ibn_101x': 'resnet101_ibn_a-59ea0ac6.pth',
    'se_ibn_101x': 'se_resnet101_ibn_a-fabed4e2.pth',
}
...
def build_resnet_backbone(cfg):
    ...
    if pretrain:
        ...
        if pretrain_path:
            pretrain_path = os.path.join(pretrain_path, model_name[depth])
            try:
