...
class GeneralizedMeanPooling(nn.Module):
    ...
    The caption is of size H x W, for any input size.
    The number of caption features is equal to the number of input planes.
    Args:
        output_size: the target caption size of the image of the form H x W.
