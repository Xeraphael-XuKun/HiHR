...
_C.MODEL.BACKBONE.BACKBONE_TYPE = "resnet50"
...
# If use view token in backbone
_C.MODEL.BACKBONE.WITH_VIEW = False
_C.MODEL.BACKBONE.WITH_FUSION = False  # TRUE #view decoupling
_C.MODEL.BACKBONE.WITH_HIERARCHY = False  # TRUE #view decoupling
_C.MODEL.BACKBONE.HIERARCHY_SPACE = "hyperbolic"
_C.MODEL.BACKBONE.SCALING_FACTOR_I1 = 0.5
_C.MODEL.BACKBONE.SCALING_FACTOR_I2 = 2.0
_C.MODEL.BACKBONE.CURV_INIT = 0.5
_C.MODEL.BACKBONE.SELECTED_LAYER = [5, 8, 12]
...
_C.MODEL.BACKBONE.VISION_STRIDE_SIZE= 16
...
# Semantic Branch options
_C.MODEL.BACKBONE.SEMANTIC_NAME = "clip"
_C.MODEL.BACKBONE.SEMANTIC_TYPE = "ViT-B-32"
_C.MODEL.BACKBONE.SEMANTIC_PRETRAIN = True
_C.MODEL.BACKBONE.SEMANTIC_PRETRAIN_PATH = ''
_C.MODEL.BACKBONE.SEMANTIC_VISION_STRIDE_SIZE= 16
...
# SupConLoss Loss options
_C.MODEL.LOSSES.SUP = CN()
_C.MODEL.LOSSES.SUP.TEMPERATURE = 1.0

# Prototype Loss options
_C.MODEL.LOSSES.PRO = CN()
_C.MODEL.LOSSES.PRO.MARGIN = 0.3
_C.MODEL.LOSSES.PRO.NORM_FEAT = False
_C.MODEL.LOSSES.PRO.HARD_MINING = False
_C.MODEL.LOSSES.PRO.SCALE = 1.0
_C.MODEL.LOSSES.PRO.ALIGN_CHOICE = ""
