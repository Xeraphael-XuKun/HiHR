...
test -f /mnt/cache/wanghanzhi/XK/HiHR/logs/WHUMARS/HiHR/model_best.pth
...
exec env CUDA_VISIBLE_DEVICES=0 WORLD_SIZE=1 PYTHONUNBUFFERED=1 \
  ...
  --num-gpus 1 \
  --eval-only \
  MODEL.WEIGHTS /mnt/cache/wanghanzhi/XK/HiHR/logs/WHUMARS/HiHR/model_best.pth \
  OUTPUT_DIR /mnt/cache/wanghanzhi/XK/HiHR/logs/WHUMARS/HiHR/eval_model_best_epoch60 \
